...
<div class= 'compalinace-page'>
    ...
    <p class='content-text'>
        This privacy policy sets out how WAZED ALI
        uses and protects any information that you give
        WAZED ALI when you use this website.
    </p>
    <p class='content-text'>
        WAZED ALI is committed to ensuring that your
    ...
    <p class='content-text'>
        WAZED ALI may change this policy from time
