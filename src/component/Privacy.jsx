...
<div class= 'compalinace-page'>
    ...
    <p class='updated-date'>Last updated on Aug 3rd 2023</p>
    <p class='content-text'>
        This privacy policy sets out how INDIAGREEN
        uses and protects any information that you give
        INDIAGREEN when you use this website.
    </p>
    <p class='content-text'>
        INDIAGREEN is committed to ensuring that your
    ...
    <p class='content-text'>
        INDIAGREEN may change this policy from time
